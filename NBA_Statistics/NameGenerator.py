...
def Update_Name_URLs():
    ...
    with open('NBA_Statistics/NBA_Statistics/TeamReference.csv', newline = '') as team_file:
    ...
    with open('NBA_Statistics/NBA_Statistics/PlayerReference.json', 'w', encoding='utf8') as player_file:
